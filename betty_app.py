...
with st.sidebar:
    ...
    if is_cloud:
        st.info("🔥 **Cloud Mode**: In-memory knowledge base")
        if st.button("🔄 Refresh Knowledge Base", use_container_width=True, type="secondary"):
        ...
        st.info("💾 **Local Mode**: Persistent storage")
